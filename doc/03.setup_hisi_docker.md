...
```bash
    ...
    #
    docker run -it -v /tmp/.X11-unix:/tmp/.X11-unix -v $HOME:/root/host -p 20122:22 --name caffe111 f367dc607a0e
...
#For ssh
    passwd root
    service ssh start
    ssh -X root@192.168.9.xxx -p 20122
```
...
bcea08d31235   a2f2977ae003           "/bin/bash"              About a minute ago   Up About a minute   0.0.0.0:20122->22/tcp, :::20122->22/tcp   caffe111
