...
#2 in caffe
    ...
    atc  --dump_data=0 --input_shape="data:1,3,320,320" --input_type="data:UINT8" --log_level=0 --weight="./imvt_model3/imvt20_yolo3_train.caffemodel" --online_model_type=0 --batch_num=256 --input_format=NCHW --output="./model_yuv/yolov3" --soc_version=SS928V100 --insert_op_conf=./insert_op_yuv420.cfg --framework=0 --compile_mode=0 --save_original_model=true --model="./imvt_model3/imvt20_yolo3_train.prototxt" --image_list="data:./data/image_ref_list.txt"

    #Output Path on gmd:
    cp ~/hidocker/Resources/yolo/model_yuv/yolov3_original.om  ~/nfs_4e6e437f58/
...
#build yolo
    ...
    cd /root/gmd/hidocker/Resources/yolo/build
