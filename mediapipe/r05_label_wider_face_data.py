    ...
    with mpFaceDetector.FaceDetection(min_detection_confidence=0.7) as faceDetection:
        ...
        for _, imagef in enumerate(imagefiles):
            ...
            if config["auto_label"]:
                ...
                os.rename(labelfile, "labelfile" + ".bk")
                new_labelfile = labelfile
            ...
            if config["show_image"]:
                ...
                time.sleep(1)
                if (cv2.waitKey(50) & 0xFF == ord(EXIT_KEY)):
                    break
...
if __name__ == '__main__':
    ...
    images = [
        "/home/leo/myhome/WIDER_train/train/images/0--Parade/0_Parade_marchingband_1_849.jpg",
        "/home/leo/myhome/WIDER_train/train/images/0--Parade/0_Parade_Parade_0_904.jpg",
        "/home/leo/myhome/WIDER_train/train/images/0--Parade/0_Parade_marchingband_1_799.jpg",
        "/home/leo/myhome/WIDER_train/train/images/0--Parade/0_Parade_marchingband_1_117.jpg",
    ]
    auto_label_face_for_yolo(images, config)

    # /mnt/214cd1a6-9d1b-4b2a-9770-425b64e6884f/myhome/dataset/VOCdevkit/VOC2007/JPEGImages/000017.jpg
    # /mnt/214cd1a6-9d1b-4b2a-9770-425b64e6884f/myhome/dataset/VOCdevkit/VOC2007/labels/000017.jpg

    # /mnt/214cd1a6-9d1b-4b2a-9770-425b64e6884f/myhome/dataset/VOCdevkit/VOC2012/JPEGImages/2011_003098.jpg
    # /mnt/214cd1a6-9d1b-4b2a-9770-425b64e6884f/myhome/dataset/VOCdevkit/VOC2012/labels/2011_003098.jpg
