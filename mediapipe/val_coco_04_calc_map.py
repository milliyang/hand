...
if __name__ == '__main__':
    ...
    parser.add_argument("-d", "--det", type=str, default="/home/leo/coco/val_yolo_labels/val2017", help="Full path to detection results folder")
    parser.add_argument("-g", "--gt", type=str, default="/home/leo/coco/val_gt_labels/val2017", help="Full path to ground truth folder")
    ...
    parser.add_argument("-n", "--names", default="value/coco.names", help="Full path of file containing names of classes index wise")
