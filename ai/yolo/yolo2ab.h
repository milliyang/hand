...
{
public:
    Yolo2AB(const string &model_file, const string &trained_file, const string &mean_file, const string &label_file);
...
private:
    ...
    int classes_;
    int total_bbox_;
    float biases_[10];  //l.biases = calloc(n * 2, sizeof(float));
