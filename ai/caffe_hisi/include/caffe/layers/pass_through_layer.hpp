 ...
 */
    ...
    class PassThroughLayer : public Layer<Dtype> {
    public:
    ...
    template<typename Dtype>
    void pass_through_cpu(Dtype *x, int w, int h, int c, int batch, int stride, int forward, Dtype *out)
    {
        int b,i,j,k;
    ...
    template<typename Dtype>
    void pass_through_cpu(const Dtype *bottom_data, const int b_w, const int b_h,
